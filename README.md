...
> [!Important]  
> FSRS has been natively integrated into Anki v23.10. If you are using Anki v23.10 or newer, refer to [this tutorial](docs/tutorial.md). If you are using an older version of Anki, continue reading ahead.
